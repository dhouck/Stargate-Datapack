...
execute as @s[scores={d_animation_2=2}] at @s run function animations:pegasus_chevron1
...
execute as @s[scores={d_animation_2=4}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=2,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=12}] at @s run function animations:pegasus_chevron2
...
execute as @s[scores={d_animation_2=14}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=3,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=22}] at @s run function animations:pegasus_chevron3
...
execute as @s[scores={d_animation_2=24}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=4,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=32}] at @s run function animations:pegasus_chevron4
...
execute as @s[scores={d_animation_2=34}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=7,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=42}] at @s run function animations:pegasus_chevron5
...
execute as @s[scores={d_animation_2=44}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=8,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=52}] at @s run function animations:pegasus_chevron6
...
execute as @s[scores={d_animation_2=54}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=9,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=62,s8=0}] at @s run function animations:pegasus_chevron7
...
execute as @s[scores={d_animation_2=64,s8=0}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=1,distance=0..0.1] remove off
execute as @s[scores={d_animation_2=64,s8=0}] at @s run scoreboard players set @s d_animation_2 95

execute as @s[scores={d_animation_2=62,s8=1..}] at @s run function animations:pegasus_chevron8
execute as @s[scores={d_animation_2=64,s8=1..}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=5,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=72,s9=0,s8=1..}] at @s run function animations:pegasus_chevron7_2
...
execute as @s[scores={d_animation_2=74,s9=0,s8=1..}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=1,distance=0..0.1] remove off
execute as @s[scores={d_animation_2=74,s9=0,s8=1..}] at @s run scoreboard players set @s d_animation_2 95

execute as @s[scores={d_animation_2=72,s9=1..}] at @s run function animations:pegasus_chevron9
execute as @s[scores={d_animation_2=74,s9=1..}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=6,distance=0..0.1] remove off

execute as @s[scores={d_animation_2=82}] at @s run function animations:pegasus_chevron7
...
execute as @s[scores={d_animation_2=84}] at @s run tag @e[tag=stargate,tag=chevron,tag=pegasus,tag=1,distance=0..0.1] remove off



scoreboard players add @s[scores={d_animation_2=1..},tag=!chevron_encoding] d_animation_2 1