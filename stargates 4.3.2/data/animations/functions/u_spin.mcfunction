...
execute as @s[scores={d_animation_3=1..,u_rotate_dif=..-1},tag=spin] at @s run scoreboard players add @e[type=armor_stand,tag=stargate,tag=universe,tag=cheveron_light] r 1
...
execute as @s[scores={d_animation_3=1..,u_rotate_dif=1..},tag=spin] at @s run scoreboard players remove @e[type=armor_stand,tag=stargate,tag=universe,tag=cheveron_light] r 1
