tag @s add stargate.current_gate
...
execute as @s[scores={stargate_state=9..400}] at @s as @e[tag=stargate,tag=ctrl,tag=!outgoing] if score @s connection_id = @e[tag=stargate.current_gate,limit=1] connection_id run scoreboard players operation @s stargate_state = @e[tag=stargate.current_gate,limit=1] r_stargate_state
...
execute as @s[tag=X,tag=7x7,scores={stargate_state=2000..}] align xyz positioned ~-2 ~-1 ~ as @e[dx=4,dy=4,dz=0,tag=!stargate,tag=!sg_override] unless score @s travel_cooldown = @e[tag=stargate.current_gate,limit=1] connection_id run damage @s 340282346638528859811704183484516925440 stargates:wrong_way
execute as @s[tag=Z,tag=7x7,scores={stargate_state=2000..}] align xyz positioned ~ ~-1 ~-2 as @e[dx=0,dy=4,dz=4,tag=!stargate,tag=!sg_override] unless score @s travel_cooldown = @e[tag=stargate.current_gate,limit=1] connection_id run damage @s 340282346638528859811704183484516925440 stargates:wrong_way
execute as @s[tag=X,tag=5x5,scores={stargate_state=2000..}] align xyz positioned ~-1 ~-1 ~ as @e[dx=2,dy=3,dz=0,tag=!stargate,tag=!sg_override] unless score @s travel_cooldown = @e[tag=stargate.current_gate,limit=1] connection_id run damage @s 340282346638528859811704183484516925440 stargates:wrong_way
execute as @s[tag=Z,tag=5x5,scores={stargate_state=2000..}] align xyz positioned ~ ~-1 ~-1 as @e[dx=0,dy=3,dz=2,tag=!stargate,tag=!sg_override] unless score @s travel_cooldown = @e[tag=stargate.current_gate,limit=1] connection_id run damage @s 340282346638528859811704183484516925440 stargates:wrong_way

tag @s remove stargate.current_gate