...
execute as @e[tag=stargate,tag=ctrl,scores={stargate_state=12..399}] at @s as @e[distance=0..2.9] at @s unless entity @s[tag=stargate] if block ~ ~1 ~ minecraft:light run tag @s add w_transport
