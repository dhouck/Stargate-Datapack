...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=1}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=5}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=9}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=13}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=17}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=21}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=25}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=29}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
...
execute as @e[tag=stargate,tag=pegasus,tag=animation,tag=on,scores={p_lightup_pos=33}] at @s run playsound minecraft:stargates.pegasus_inbound_chevron block @a[distance=0..16]
